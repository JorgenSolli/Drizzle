			...
			>
				...
				<template #content>
                    <div v-if="locations.length">
                        ...
                        <Message :show="didSave" success :message="`The list has been saved as ${savedName}`" class="mt-4"/>
                    </div>

                    <Message :show="!locations.length" info message="You need to add at least one location before you can save the list"/>
				</template>
